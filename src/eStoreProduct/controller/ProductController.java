	...
	private String generateCartsHTML(List<Product> products) {
		...
		for (Product product : products) {
			htmlContent.append("<div class=\"col-lg-4 col-md-6 mb-4\">\n").append("<div class=\"card h-100\">\n")
					...
					.append("<button class=\"btn btn-secondary addToWishListFromCart\">Add to Wishlist</button>\n")
					.append("</div>\n").append("</div>\n").append("</div>\n");
	...
	private String generateWishlistHTML(List<Product> products) {
		...
		for (Product product : products) {
			htmlContent.append("<div class=\"col-lg-4 col-md-6 mb-4\">\n").append("<div class=\"card h-100\">\n")
					...
					.append("<button class=\"btn btn-secondary addToCart\" data-product-id=\"").append(product.getId())
