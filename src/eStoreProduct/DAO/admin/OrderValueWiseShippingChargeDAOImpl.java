...
import eStoreProduct.model.admin.output.OrderValueWiseShippingChargeMapper;
...
public class OrderValueWiseShippingChargeDAOImpl implements OrderValueWiseShippingChargeDAO {
	...
	public boolean updateCharge(OrderValueWiseShippingCharge ord) {
		try {
			jdbcTemplate.update(updateCh, ord.getOrdvlFrom(), ord.getOrdvlTo(), ord.getOrdvlShippingAmount(),
					ord.getOrdvlId());
			return true;
		} catch (Exception e) {
			e.printStackTrace();
