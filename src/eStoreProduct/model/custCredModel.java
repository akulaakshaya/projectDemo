...
public class custCredModel {
	...
	public custCredModel(String custName, String custMobile, String custLocation, String custEmail, String custAddress,int custPincode,
			String custSAddress,int custSpincode , Timestamp custLastLoginDate, String custPassword) {
	...
	public String toString() {
		return "USER{" + "Cust Name=" + custName + '}';
	}
