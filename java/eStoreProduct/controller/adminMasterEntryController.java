...
public class adminMasterEntryController {
	...
	public String generateEditableStockSummary(List<stockSummaryModel> stocks1) {
		...
		for (stockSummaryModel stock : stocks1) {
			...
			.append("<td>").append(stock.getProd_title()).append("</td>\n")
			.append("<td>").append(stock.getProd_prct_id()).append("</td>\n")
			.append("<td>")
			.append("<input type=\"text\" id=\"prodGstcId-input\" value=\"").append(stock.getProd_gstc_id()).append("\">")
			.append("</td>\n")
			.append("<td>").append(stock.getProd_brand()).append("</td>\n")
			.append("<td>")
			.append("<input type=\"text\" id=\"imageUrl-input\" value=\"").append(stock.getImage_url()).append("\">")
			.append("</td>\n")
			.append("<td>")
			.append("<input type=\"text\" id=\"prodDesc-input\" value=\"").append(stock.getProd_desc()).append("\">")
			.append("</td>\n")
			.append("<td>")
			.append("<input type=\"text\" id=\"reorderlevel-input\" value=\"").append(stock.getReorderlevel()).append("\">")
			.append("</td>\n")
			.append("<td>").append(stock.getPrct_title()).append("</td>\n")
			.append("<td>").append(stock.getSgst()).append("</td>\n")
			.append("<td>").append(stock.getIgst()).append("</td>\n")
			.append("<td>").append(stock.getCgst()).append("</td>\n")
			.append("<td>").append(stock.getGst()).append("</td>\n")
			.append("<td>").append(stock.getProd_price()).append("</td>\n")
			.append("<td>")
			.append("<input type=\"text\" id=\"prodStock-input\" value=\"").append(stock.getProd_stock()).append("\">")
			.append("</td>\n")
			.append("<td>")
			.append("<input type=\"text\" id=\"prodMrp-input\" value=\"").append(stock.getProd_mrp()).append("\">")
			.append("</td>\n")
			.append("<td>")
			...
			.append("\" data-prod-id=\"").append(stock.getProd_id())
			.append("\" data-reorderlevel-id=\"").append(stock.getReorderlevel())
			.append("\" data-stock-id=\"").append(stock.getProd_stock())
			.append("\" data-mrp-id=\"").append(stock.getProd_mrp())
	...
	@ResponseBody
	public String showUpdatedEditableStocks(@RequestParam(value = "gstcid") int gstcid,@RequestParam(value = "imageurl") String imageurl,
			@RequestParam(value = "prodid") int prodid,@RequestParam(value = "reorderlevel") int reorderlevel,
			@RequestParam(value = "stock") double updatedstock,@RequestParam(value = "mrp") double mrp,Model model) {
