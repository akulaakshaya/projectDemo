...
public class adminShipmentsController {
	...
	@GetMapping("/updateShippedOrderStatus")
	@ResponseBody
	public String updateStatusOrder(@RequestParam(value = "x", required = false) int x, Model model) {
		
        	od.updateOrderShipmentStatus(x, "DELIVERED");
