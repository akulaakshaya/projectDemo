...
<head>
    ...
    <script>
 // Get a reference to the "orders" link
  // Get a reference to the "orders" link
var ordersLink = document.getElementById('orders-link');

// Attach a click event listener to the "orders" link
ordersLink.addEventListener('click', function(event) {
    event.preventDefault(); // Prevent the default link behavior

    // Make an AJAX request to fetch the new content
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'signIn', true); // Replace 'path/to/orders-content' with the actual URL or endpoint to fetch the orders content
